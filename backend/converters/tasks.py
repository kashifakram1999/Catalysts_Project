...
@shared_task(
    ...
    soft_time_limit=2 * 60 * 60,  # Allow 2 hours before soft timeout for large runs
    time_limit=(2 * 60 * 60) + 300,  # Hard limit trails soft limit by 5 minutes
)
...
@shared_task(
    ...
    soft_time_limit=4 * 60 * 60,  # 4 hours per batch
...
@shared_task(
    ...
    soft_time_limit=3 * 60 * 60,  # 3 hours total
